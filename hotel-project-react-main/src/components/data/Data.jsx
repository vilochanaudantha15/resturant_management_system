...
export const roomItems = [
  {
    ...
    description:
      "Experience a blend of comfort and elegance in our Junior Suite. Perfect for both leisure and business travelers, this suite features modern amenities, a cozy sitting area, and stunning views of the city skyline.",
  ...
  },
  {
    ...
    description:
      "Indulge in luxury with our Executive Suite, featuring a spacious living area, plush bedding, and exclusive access to our executive lounge. Ideal for guests seeking extra space and added convenience.",
    yellowbtn: "View Details",
    darkbtn: "Book Now",
  },
  {
    ...
    description:
      "Our Super Deluxe room offers the ultimate in luxury and comfort. Enjoy the opulent decor, premium amenities, and a breathtaking view that will make your stay truly unforgettable.",
    yellowbtn: "View Details",
    darkbtn: "Book Now",
  },
];
